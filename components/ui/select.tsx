...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn(
        "pointer-events-none my-1.5 h-px bg-border",
        className,
      )}
      {...props}
    />
